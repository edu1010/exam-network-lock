...
/// <summary>Light, modern palette and small styling helpers shared across the client UI.</summary>
internal static class Theme
{
    ...
    public static readonly Color Idle = Color.FromArgb(148, 163, 184);
